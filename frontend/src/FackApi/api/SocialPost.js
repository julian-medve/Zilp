...
export const Posts = [
  {
    ...
    comments: [
      { image: require('../../assets/images/user/user-04.jpg'), user: { name: 'Anna Sthesia', msg: 'Lorem ipsum dolor sit amet', time: moment(new Date(), 'YYYY-MM-DD H:i:s').add(-3, 'days') }, is_commentLike: true },
  ...
  },
  {
    ...
    comments: [
      { image: require('../../assets/images/user/user-04.jpg'), user: { name: 'Anna Sthesia', msg: 'Lorem ipsum dolor sit amet', time: moment(new Date(), 'YYYY-MM-DD H:i:s').add(-4, 'days') }, is_commentLike: true },
